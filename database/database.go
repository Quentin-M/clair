...
type Datastore interface {
	...
	// Fixes
	InsertVulnerabilityFix(vulnerabilityNamespace, vulnerabilityName string, fixes []FeatureVersion) error
	DeleteVulnerabilityFix(vulnerabilityNamespace, vulnerabilityName string) error
